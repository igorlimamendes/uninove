...
public class Prj_Sobrecarga {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Object soma:" + X.soma("1A", 2.0d));
        System.out.println("Object soma:" + X.soma("1B", 2.0d));
        System.out.println("Object soma:" + X.soma("1C", 2.0d));
        System.out.println("Object soma:" + X.soma("1D", 2.0d));
        System.out.println("Object soma:" + X.soma("1E", 2.0d));
